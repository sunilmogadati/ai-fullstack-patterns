// shadcn/ui Card — "new-york" style, JS adaptation.
//
// shadcn ships Card as a small family — Card, CardHeader, CardTitle,
// CardDescription, CardContent, CardFooter — that compose with no implicit
// layout. The consumer controls everything; the family just provides
// consistent padding, typography, and border.
